...
<html>
    <head>
        ...
        <title>Nieuwe Vraag toevoegen - Pajottersapplicatie</title>
    ...
    <body>
		...
		<div id="MiddenPaneel">
			<div id="Inhoud">
				<p>Vul de het onderstaande formulier in om een nieuwe Vraag toe te voegen.</p>
		        <c:url var="url" value="/Teler/nieuweVraag.html">
		        <c:param name="PartijId" value="${rol.id}" />
		        </c:url>
		        <form:form action="${url}" commandName="devraag">   <%-- Spring form tags --%>
			            <table>
				            <tbody>
				            	<tr>
