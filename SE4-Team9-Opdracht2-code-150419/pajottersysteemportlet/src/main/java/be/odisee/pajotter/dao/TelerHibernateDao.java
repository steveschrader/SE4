...
public class TelerHibernateDao extends HibernateDao implements TelerDao {
    ...
    public void updateTeler(Teler teler) {
        //het update van de velden
        //Teler telerupdate = getTelerById(teler.getId());
        /*telerupdate.setVoornaam(teler.getVoornaam());
        telerupdate.setFamilienaam(teler.getFamilienaam());
        telerupdate.setEmailadres(teler.getEmailadres());
        telerupdate.setPaswoord(teler.getPaswoord());
        telerupdate.setAdres(teler.getAdres());
        telerupdate.setTelefoon(teler.getTelefoon());*/
